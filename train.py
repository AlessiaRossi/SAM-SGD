...
def load_dataset(name, batch_size):
    """
    Carica il dataset specificato e lo suddivide in train, validation e test.
    Se il dataset è già presente, non viene riscaricato.
    """
    data_dir = "./data"  # Directory in cui salvare i dati
    ...
    # Carica il dataset di training e test
    ...
    # Suddivide il dataset di training in train e validation
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rho", default=0.05, type=float, help="Rho per SAM")
    ...
    parser.add_argument("--optimizer", default="sgd", type=str, choices=["sgd", "sam"], help="Ottimizzatore da usare (sgd o sam)")
    ...
    # Caricamento del dataset e configurazione del modello
    ...
    # Configurazione dei valori di lambda
    ...
    for lambda_val in lambda_values:
        ...
        # Configura l'ottimizzatore in base all'argomento fornito
        ...
        # Esegui il training
        train(model, optimizer, scheduler, dataset, args, log, use_sam=use_sam)
